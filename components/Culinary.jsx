    ...
    return (
        <>
           <div className="pt-32 px-4">
                ...
                <div className="flex-col text-left w-full lg:w-11/12 xl:w-full px-2">
                            <h1 className="font-bold font-inter text-2xl sm:text-3xl md:text-4xl xl:text-[42px] text-left mb-[10px]">Explore <span className="text-red-color">Top Culinary</span></h1>
                            <p className="font-medium font-inter text-subtitle-color text-sm sm:text-base md:text-lg lg:text-xl text-left mb-5">Enjoy the best culinary tasting experience of your life</p>
                            <Link href="#">  
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide flex-col flex items-center">
                                <img
                                    ...
                                    src="/Assets/papeda.jpg"
                                    alt="apple watch photo"
                                />
                                <h1 className="font-bold font-inter text-sm mb-[5px]">Papeda</h1>
                            ...
                            <div className="swiper-slide flex flex-col items-center">
                                <img
                                    className="object-cover mb-[10px] w-[320px] h-[280px] sm:w-[360px] sm:h-[300px] md:w-[420px] md:h-[320px] lg:w-[512px] lg:h-[340px] xl:w-[580px] xl:h-[360px] rounded-[25px]"
                                    src="/Assets/rujak.jpg"
                                    alt="apple watch photo"
                                />
                                <h1 className="font-bold font-inter text-sm mb-[5px]">Rujak Natsepa</h1>                          
                                <p className="font-inter font-semibold text-sm"><i className='bx bxs-star text-[#FFD600] relative top-[1px]' ></i>5.0 <span className="font-medium text-xs text-subtitle-color">(1K Reviews)</span></p>
                            </div>
                        </div>
